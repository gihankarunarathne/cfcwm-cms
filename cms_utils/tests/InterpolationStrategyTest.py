...
class UtilInterpolationTest(unittest.TestCase):
    ...
    def test_average_smaller(self):
        ...
        self.assertListEqual(new_timeseries[1], [datetime.strptime('2017-11-15 08:21:29', '%Y-%m-%d %H:%M:%S'), 6.5])
        ...
        for t in new_timeseries:
            print(t)
        self.assertEqual(len(new_timeseries), 3)
        self.assertListEqual(new_timeseries[1], [datetime.strptime('2017-11-15 00:01:00', '%Y-%m-%d %H:%M:%S'), 6.5])
    ...
    def test_maximum_smaller(self):
        ...
        print('\n')
        self.assertEqual(len(new_timeseries), 3)
        self.assertListEqual(new_timeseries[1], [datetime.strptime('2017-11-15 08:21:29', '%Y-%m-%d %H:%M:%S'), 8.0])
        ...
        new_timeseries = \
            InterpolationStrategy.get_strategy_for_smaller(InterpolationStrategy.Maximum)(timeseries2, time_interval)
        print('Result::')
        for t in new_timeseries:
            print(t)
        self.assertEqual(len(new_timeseries), 3)
        self.assertListEqual(new_timeseries[1], [datetime.strptime('2017-11-15 00:01:00', '%Y-%m-%d %H:%M:%S'), 7.0])
